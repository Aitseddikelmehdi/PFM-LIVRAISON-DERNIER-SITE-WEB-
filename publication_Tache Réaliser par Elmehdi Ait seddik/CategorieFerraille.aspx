<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="CategorieFerraille.aspx.cs" Inherits="Test_annocycle.CategorieFerraille" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="input-group-prepend">
    <label class="input-group-text" for="inputGroupSelect01">Pieces/Ferraille</label>
  </div>
  <select class="custom-select" id="inputGroupSelect01">
    <option selected>Pièces d'automobile</option>
    <option value="1">Pièces pour moteur</option>
    <option value="2">Pièces pour vélos</option>
    <option value="3">Ferraille générale</option>
  </select>
</div></br></br></br>
