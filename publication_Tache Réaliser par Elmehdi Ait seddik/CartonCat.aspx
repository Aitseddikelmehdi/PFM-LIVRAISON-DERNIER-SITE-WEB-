<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="CartonCat.aspx.cs" Inherits="Test_annocycle.CartonCat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="input-group-prepend">
    <label class="input-group-text" for="inputGroupSelect01">Carton</label>
  </div>
  <select class="custom-select" id="inputGroupSelect01">
    <option selected>Carton ondulé</option>
    <option value="1">Carton plat</option>
    <option value="2">Carton pâte</option>
    <option value="3">Boîtes de pizza propre</option>
    <option value="4">Carton de lait et de jus</option>
  </select>
</div></br></br></br>
