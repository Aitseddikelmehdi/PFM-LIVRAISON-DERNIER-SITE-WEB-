<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="Catégorie_plastique.aspx.cs" Inherits="Test_annocycle.Catégorie_plastique" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="input-group-prepend">
    <label class="input-group-text" for="inputGroupSelect01">Plastique</label>
  </div>
  <select class="custom-select" id="inputGroupSelect01">
    <option selected>Bouteilles d’eau, de jus, de boisson gazeuse</option>
    <option value="1">Contenant de produits alimentaires (margarine, yogourt, crème glacée, muffins)</option>
    <option value="2">Contenant de produit d’entretien (liquide à vaiselle, eau de javel, etc.)</option>
    <option value="3">Contenants de produits cosmétiques(shampoing, crème)</option>
    <option value="4">Bouchons et couvercles de plastique</option>
    <option value="4">Sac de plastique (transparent seulement)</option>
    <option value="4">Sac de pain et de lait vide et propre</option>
  </select>
</div></br></br></br>
...
<input type="file" name="pic" accept="image/*">
  ...
  <div class="input-group-prepend">
    <span class="input-group-text" runat="server"><i class="fas fa-user"></i></span>
    
  </div>
  <input type="text" runat="server" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" >
</div>
