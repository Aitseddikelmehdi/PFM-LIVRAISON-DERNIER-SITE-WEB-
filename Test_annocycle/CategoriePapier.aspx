<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="CategoriePapier.aspx.cs" Inherits="Test_annocycle.CategoriePapier" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="input-group-prepend">
    <label class="input-group-text" for="inputGroupSelect01">Papier</label>
  </div>
  <select class="custom-select" id="inputGroupSelect01">
    <option selected>Papier journal</option>
    <option value="1">Papier d’emballage</option>
    <option value="2">Papier Kraft</option>
    <option value="3">Calendriers</option>
