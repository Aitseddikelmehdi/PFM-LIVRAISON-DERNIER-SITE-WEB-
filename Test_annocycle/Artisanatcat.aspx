<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="Artisanatcat.aspx.cs" Inherits="Test_annocycle.Artisanatcat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="input-group-prepend">
    <label class="input-group-text" for="inputGroupSelect01">Artisanat</label>
  </div>
  <select class="custom-select" id="inputGroupSelect01">
    <option selected>HABILLEMENT ET BIJOUX</option>
    <option value="1">DÉCORATION</option>
    <option value="2">MAROQUINERIE</option>
    <option value="3">ART DE TABLE</option>
    <option value="5">VANNERIE</option>
    <option value="6">SOUVENIRS</option>
    <option value="7">TAPIS</option>
    <option value="8">ARTISANAT DU MONDE</option>
  </select>
</div></br></br></br>
